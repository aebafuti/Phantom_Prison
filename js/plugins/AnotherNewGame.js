...
(function () {
    ...
    Scene_Title.prototype.loadAngSetting = function() {
    	...
    	var claer = chikuwa.get(1);
    	var talk = chikuwa.get(2);
    	ANGSettingManager.visible = claer;
    	ANGSettingManager.enable = Object.prototype.toString.call(talk) === '[object Object]'
